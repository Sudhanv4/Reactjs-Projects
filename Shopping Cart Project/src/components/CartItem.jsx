...
const CartItem = ({ item, itemIndex, itemLength }) => {
  ...
  return (
    <>
      <div className={`flex items-center p-2 md:p-5 justify-between ${itemIndex === itemLength - 1 ? '' : 'border-b-2 border-slate-500'}  mt-2 mb-2 md:mx-5 `}>
